...
<head>
    ...
    <title>Laporan Siswa | SIPASSA Admin</title>
...
<body>
        ...
        <aside
            ...
            <nav class="p-4">
                <div class="mb-6">
                    ...
                    {{-- <a href="/admin/registrasi-siswa" class="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/10 transition mt-1">
        ...
        <main class="flex-1 overflow-y-auto p-6">
                ...
                <div class="flex justify-between items-start flex-wrap gap-4">
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            <a href="/admin/kelola-siswa" class="text-amber-500 hover:text-amber-600 transition">
                                <i class="fas fa-arrow-left"></i> Kembali
                            </a>
                        </div>
                        <h1 class="text-3xl font-bold gradient-text">Laporan Siswa</h1>
                        <div class="mt-2 flex items-center gap-3">
                            <div class="bg-amber-100 p-3 rounded-full">
                                <i class="fas fa-user-graduate text-amber-600 text-xl"></i>
                            </div>
                            <div>
                                <p class="text-xl font-semibold text-gray-800">{{ $siswa->nama }}</p>
                    ...
                    <div class="bg-white rounded-xl shadow-sm p-4">
                        <div class="text-center">
                            <p class="text-2xl font-bold text-amber-600">{{ $totalLaporan }}</p>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border-l-4 border-blue-500">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-blue-600">{{ $proses }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl p-4 shadow-sm border-l-4 border-purple-500">
                    <div class="flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-2xl font-bold text-purple-600">{{ $pending }}</p>
                        </div>
            ...
            <div class="mb-4 flex justify-between items-center flex-wrap gap-3">
                <h2 class="text-xl font-bold text-gray-800 flex items-center gap-2">
                    <i class="fas fa-list-ul text-amber-500"></i> Riwayat Laporan
                </h2>
                <div class="relative">
            ...
            <!-- DAFTAR LAPORAN SISWA (CARD VIEW) - TOMBOL BALAS PAKAI POPUP -->
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6" id="laporanContainer">
                        ...
                        <div class="bg-gradient-to-r from-amber-500 to-amber-600 px-4 py-3 text-white">
                            <div class="flex justify-between items-center">
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="text-xs text-white/80">📅 {{ $tanggal }}</span>
                                </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="mb-3">
                                <p class="text-xs text-gray-400"><i class="fas fa-align-left text-amber-500"></i>
                                    Keterangan</p>
                                <p class="text-sm text-gray-600 bg-gray-50 p-2 rounded-lg">{{ $d->ket }}</p>
                            </div>

                            @if ($d->foto && file_exists(public_path($d->foto)))
                                <div class="mb-3">
                                    <p class="text-xs text-gray-400"><i class="fas fa-image text-amber-500"></i> Foto
                                        Laporan</p>
                                    <img src="{{ asset($d->foto) }}" alt="Foto"
                                        class="w-24 h-24 object-cover rounded-lg mt-1 shadow-sm cursor-pointer"
                                        onclick="window.open('{{ asset($d->foto) }}', '_blank')">
                                </div>
                            @endif

                            <div class="mb-3">
                                <p class="text-xs text-gray-400"><i class="fas fa-comment-dots text-amber-500"></i>
                                    Feedback Admin</p>
                            ...
                            <button type="button"
                                ...
                                class="w-full bg-amber-500 hover:bg-amber-600 text-white py-2.5 rounded-lg text-sm font-semibold transition flex items-center justify-center gap-2">
                ...
                @empty
                    <div class="col-span-2 text-center py-12 bg-white rounded-xl">
                        ...
                        <p class="text-gray-400">Belum ada laporan dari siswa ini</p>
                    </div>
                @endforelse
            </div>
    ...
    <script>
        ...
        const laporanCards = document.querySelectorAll('.bg-white.rounded-xl.shadow-md');
        ...
        // Modal Reply Functions (SAMA SEPERTI DI DASHBOARD UTAMA)
